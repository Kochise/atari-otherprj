...
#
decbin:
	fmov.l		&0,%control	# clr real fpcr
	movm.l		&0x3c00,-(%sp)	#  {%d2-%d5}
#
# Calculate exponent:
...
calc_e:
	...
	mov.l		ETEMP(%a6),(%a0)	# save input bcd value
	mov.l		ETEMP_HI(%a6),4(%a0)	# save words 2 and 3
	mov.l		ETEMP_LO(%a6),8(%a0)	# and work with these
...
e_save:
	mov.l		%d1,L_SCR1(%a6)	# save exp in memory
#
#
# Calculate mantissa:
...
#
ap_st_z:
	mov.l		L_SCR1(%a6),%d1	# load expA for range test
...
ap_p_fx:
	...
	mov.l		L_SCR1(%a6),%d1	# get adjusted exp from memory
...
#
ap_p_fm:
	mov.l		&PTENRN,%a1	# get address of power-of-ten table
...
pwrten:
	...
	fmov.l		%d3,%control	# write new FPCR
