...
ATANA3:
	long		0xBFF6687E,0x314987D8
ATANA2:
	long		0x4002AC69,0x34A26DB3

ATANA1:
	long		0xBFC2476F,0x4E1DA28E
ATANB6:
	long		0x3FB34444,0x7F876989

ATANB5:
	long		0xBFB744EE,0x7FAF45DB
ATANB4:
	long		0x3FBC71C6,0x46940220

ATANB3:
	long		0xBFC24924,0x921872F9
ATANB2:
	long		0x3FC99999,0x99998FA9

ATANB1:
	long		0xBFD55555,0x55555555
ATANC5:
	long		0xBFB70BF3,0x98539E6A

ATANC4:
	long		0x3FBC7187,0x962D1D7D
ATANC3:
	long		0xBFC24924,0x827107B8

ATANC2:
	long		0x3FC99999,0x9996263E
ATANC1:
	long		0xBFD55555,0x55555536

PPIBY2:
	long		0x3FFF0000,0xC90FDAA2,0x2168C235,0x00000000
NPIBY2:
	long		0xBFFF0000,0xC90FDAA2,0x2168C235,0x00000000
PTINY:
	long		0x00010000,0x80000000,0x00000000,0x00000000
NTINY:
	long		0x80010000,0x80000000,0x00000000,0x00000000
...
#--ENTRY POINT FOR ATAN(X), HERE X IS FINITE, NON-ZERO, AND NOT NAN'S
	...
	cmp.l		%d0,&0x3FFB8000	# |X| >= 1/16?
	bge.b		ATANOK1
	bra.w		ATANSM

ATANOK1:
	cmp.l		%d0,&0x4002FFFF	# |X| < 16 ?
	ble.b		ATANMAIN
	bra.w		ATANBIG
...
ATANMAIN:
	...
	mov.w		&0x0000,XDCARE(%a6)	# CLEAN UP X JUST IN CASE
...
#--SAVE REGISTERS FP2.
	...
	mov.l		%d0,%d2		# THE EXPO AND 16 BITS OF X
	and.l		&0x00007800,%d0	# 4 VARYING BITS OF F'S FRACTION
	...
	lea		ATANTBL,%a1
	add.l		%d0,%a1		# ADDRESS OF ATAN(|F|)
	mov.l		(%a1)+,ATANF(%a6)
	mov.l		(%a1)+,ATANFHI(%a6)
	mov.l		(%a1)+,ATANFLO(%a6)	# ATANF IS NOW ATAN(|F|)
	mov.l		X(%a6),%d0	# LOAD SIGN AND EXPO. AGAIN
	and.l		&0x80000000,%d0	# SIGN(F)
